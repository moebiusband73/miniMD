...
int main(int argc, char** argv)
{
    ...
    if(me == 0) {
        ...
        printf("%i %i %i %lf %lf %lf %lf %lf %lf %lf PERF_SUMMARY %lf\n\n\n",
                nprocs, integrate.ntimes, natoms,
                timer.array[TIME_TOTAL], timer.array[TIME_FORCE], timer.array[TIME_NEIGH], timer.array[TIME_COMM], time_other,
                1.0 * natoms * integrate.ntimes / timer.array[TIME_TOTAL], 1.0 * natoms * integrate.ntimes / timer.array[TIME_TOTAL] / nprocs, timer.array[TIME_TEST]);
